...
function startPage(){
  MovieDetails(<?php echo e($id); ?>);
  MovieCast(<?php echo e($id); ?>);
  SimilarMovie(<?php echo e($id); ?>);
}
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          x+=  "<div class='w3-quarter'>"+
              ...
              "<a href='<?php echo e('/RetriveCastDetails/'); ?>"+myObj.cast[i].id+"' class='btnBrowser' style='text-decoration: none;'>See More!</a>"+
              "</div>";
          }
          //stop
