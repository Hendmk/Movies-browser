...
<script>
$(this).ready(function() {
CastDetails(<?php echo e($id); ?>);
MovieCastIn(<?php echo e($id); ?>);
});
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          x+=  "<div class='w3-quarter'>"+
              ...
              "<a href='<?php echo e('/MovieDetails/'); ?>"+myObj.cast[i].id+"' class='btnBrowser' style='text-decoration: none;'>Details!</a>"+
              "</div>";
          }
          //stop
